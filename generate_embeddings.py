...
def generate_embeddings(
    ...
    # Few-shot prototype creation: mean embedding per class.
    # This supports fast nearest-prototype recognition during inference.
    prototypes, class_names = compute_class_prototypes(embeddings_array, labels_array)
